...
1. **Entrada de referência**  
   ...
   - `URL`: página de referência (Investing.com ou MarketWatch).
2. **Agendamento**  
...
3. **Coleta**  
   ...
   - Seleciona parser adequado (`core.data_sources`) e extrai a variação.
...
| `core/data_sources/` | Parsers específicos (Investing, MarketWatch). |

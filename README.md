...
- **Visualizações dinâmicas**:
  ...
  - Gráfico de tendência das últimas 40 medições.
...
└── network.fetch_html()  ├─ data_sources.(investing|marketwatch)
...
core/
  ...
  data_sources/      Parsers Investing + MarketWatch
  ...
  visuals/
    ...
    trend.py         Gráfico de tendência (máx. 40 pontos)
